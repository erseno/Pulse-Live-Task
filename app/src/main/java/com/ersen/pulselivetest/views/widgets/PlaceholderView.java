package com.ersen.pulselivetest.views.widgets;
...
public class PlaceholderView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context){
        ...
        mLoadingView = inflate(context, R.layout.partial_initial_content_loading_placeholder, null);
        mInitialContentFailedToLoadView = inflate(context, R.layout.partial_initial_loading_failed_placeholder, null);
